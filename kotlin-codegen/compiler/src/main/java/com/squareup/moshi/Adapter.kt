...
internal class Adapter(
  ...
  val writerParam = ParameterSpec.builder(
      ...
      JsonWriter::class)
      .build()
  val valueParam = ParameterSpec.Companion.builder(
      nameAllocator.newName("value"),
      originalTypeName.asNullable())
      .build()
  val jsonAdapterTypeName = ParameterizedTypeName.Companion.get(
      JsonAdapter::class.asClassName(), originalTypeName)

  // selectName() API setup
  val optionsProperty = PropertySpec.Companion.builder(
